...
const BlogCard = ({ data, index }: { data: Blog; index: number }) => {
  ...
  return (
    <motion.article
      ...
      // }}
      // initial="initial"
      className="w-full odd:-rotate-1 even:rotate-1 transition-transform hover:rotate-0 md:min-h-[200px] flex flex-col  gap-3 rounded-3xl border border-gray-300 bg-gray-100 dark:bg-dark dark:border-border "
    >

    ...
    <article className="w-full  mb-10 max-w-2xl flex flex-col items-center justify-center">
      <div className="w-full flex items-center justify-start gap-x-3 px-3 mb-3">
        <Image
          alt=""
          className={`
          duration-700 aspect-square ease-in-out group-hover:opacity-75
          `}
          src={image}
          width={45}
          height={45}
        ...
        <Balancer
          className="md:text-3xl  font-semibold w-full "
          as={"h1"}
          ratio={0.5}
        >
          {name}
      ...
      <div className=" mb-3 opacity-80 px-2.5 w-full flex items-center justify-between">
      ...
      <div className="max-w-none w-full flex flex-col mt-4 gap-y-4 px-4 list-inside ">
